...
MACHINE_ARCH=arm
MACHINE_CPU=arm
CFLAGS= -Iohash -I. -I/usr/include/openbsd -DTARGET_MACHINE=\"${MACHINE}\" -DMACHINE_ARCH=\"${MACHINE_ARCH}\" -DTARGET_MACHINE_ARCH=\"${MACHINE_ARCH}\" -DTARGET_MACHINE_CPU=\"${MACHINE_CPU}\" -DMACHINE=\"${MACHINE}\" \
